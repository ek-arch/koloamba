...
8. ✅ **Phase 8 — Kolo token balance** — `kolo_balances` table in Supabase holds 3.25M rows imported from the mini-app backend. Mini-app tap-to-earn phase is closed so balances are final; no re-imports needed. Dashboard looks up balance by the user's linked Telegram handle. See [docs/session-2026-04-20.md](docs/session-2026-04-20.md).
